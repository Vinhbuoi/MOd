...
async def naptien(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
  if update.effective_chat.type == "private":
    ...
    try:
      ...
      message_text = (f"STK: <code>0966317828</code>\n"
                      f"Ngân hàng: <b>MBBANK</b>\n"
                      f"Chủ tài khoản: <b>TRAN BA VINH</b>\n\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
      ...
      if args[0] == "bank:confirm":
          ...
          reply_markup = InlineKeyboardMarkup(keyboard)
          await context.bot.send_message(chat_id=5010124398, text=admin_message, reply_markup=reply_markup,parse_mode="HTML")
